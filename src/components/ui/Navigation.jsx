  ...
  return (
    <>
      <div className={className}>
        <Header {...headerProps} />
        {fixed && (
          <div className={`fixed top-0 left-1/2 transform -translate-x-1/2 w-full min-w-[320px] max-w-[500px] h-screen z-[95] ${isMenuOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}>
