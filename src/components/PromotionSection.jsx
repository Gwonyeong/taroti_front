    ...
    <div className="flex flex-col items-center w-full py-6 mt-8 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/50 to-black flex flex-col justify-end p-8">
              <div className="text-white space-y-3">
                ...
                <p className="text-sm opacity-90">당신을 위한 더 정교한 조언</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black -mt-1">
            <div className="p-8 text-white space-y-4">
              <p className="text-sm opacity-90 leading-relaxed">
                10만건 이상의 타로 데이터 + 확실한 타로카드 전문가, 당신의 미래
                이야기를 평생 소장할 수 있는 보고서로 작성해드려요.
              </p>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 to-transparent flex items-end p-8">
                <div className="text-center w-full pb-4">
                  <h3 className="text-white text-xl font-bold leading-relaxed drop-shadow-lg">
                    지금 나의 성격유형을 이용해 작성한{" "}
                    <span className="text-blue-200">나만의 타로 보고서</span>를
                    확인해보세요!
                  </h3>
                </div>
              </div>
      ...
      <div className="w-full max-w-lg mt-12 space-y-8">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-6 rounded-xl border-2 border-purple-200">
          <div className="text-center">
            ...
            <h3 className="font-bold text-lg text-gray-900 mb-3">
              그럴듯한 조언이 아닌 '나의 성격유형'을 이용한 나에게 맞는 구체적인
              조언
            </h3>
            <div className="bg-white/70 p-4 rounded-lg space-y-2 text-left">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-purple-600">✓</span>
                <p className="text-sm text-gray-700">'나'를 구체적으로 파악</p>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-purple-600">✓</span>
            ...
            <div className="mt-3 p-3 bg-purple-100 rounded-lg text-left">
              <p className="text-xs text-purple-800">
                💡 예시: "THE FOOL(바보) 카드가 나타내는 '새로운 시작'의 의미와
                INFP인 당신의 성격을 결합해보면, 당신은 변화를 두려워하면서도
                내면의 감정을 중시하는 특성이 있습니다. 연인에게는 이런 복잡한
                마음을 솔직하게 표현하되, 구체적인 행동 계획을 함께
                제시해보세요."
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-3 gap-2 mt-4">
              <div className="bg-white/70 p-2 rounded text-center">
                <p className="text-xs font-semibold text-blue-700">카드 설명</p>
                <p className="text-xs text-gray-600 mt-1">그림 해석</p>
              </div>
              <div className="bg-white/70 p-2 rounded text-center">
                <p className="text-xs font-semibold text-blue-700">긍정/부정</p>
                <p className="text-xs text-gray-600 mt-1">키워드 분석</p>
              </div>
              <div className="bg-white/70 p-2 rounded text-center">
                <p className="text-xs font-semibold text-blue-700">연애 조언</p>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                와닿았어요. 특히 INFP인 제가 연인과 소통할 때 주의해야 할 점들을
                구체적으로 알려주셔서 실제로 관계가 많이 개선됐어요. 이 가격에
                이런 퀄리티라니 정말 대박이에요!
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                성격과 연애 스타일을 정확히 짚어주시더라구요. 애인이 저를 어떻게
                생각하는지도 신기할 정도로 맞았고, 앞으로 어떻게 관계를
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                생각하는지' 섹션이 정말 큰 도움이 됐어요. 제가 몰랐던 여자친구의
                진짜 마음을 이해하게 되었고, 왜 그런 반응을 보였는지 알게 되니까
                대화의 실마리가 풀렸어요. 이제는 서로를 더 잘 이해하게 됐습니다.
                진짜 강추해요!
              </p>
            </div>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                타로가 예측한 위기 상황이 정말로 일어나서 깜짝 놀랐어요. 다행히
                미리 조언받은 대로 대처하니까 큰 싸움 없이 넘어갈 수 있었어요.
                특히 '애인과의 위기, 미리 극복하기' 섹션에서 알려준 대처법이
                정말 유용했고, 실제로 그 상황이 왔을 때 침착하게 해결할 수
                있었습니다. 너무 신기해요!
              </p>
            </div>
          </div>
      ...
      <div className="w-full max-w-lg mt-12">
        <div className="relative rounded-lg overflow-hidden shadow-2xl"
          style={{
            boxShadow: "0 25px 60px -15px rgba(0, 0, 0, 0.7), 0 15px 30px -7px rgba(0, 0, 0, 0.5)"
          }}>
          {/* 이미지 섹션 */}
          <div className="relative">
            <img
          ...
          <div className="bg-black -mt-1 p-8">
            <div className="text-white space-y-4">
              <div className="text-center mb-6">
                <p className="text-sm text-amber-400 italic">친애하는 당신에게</p>
              </div>
              ...
              <div className="space-y-3 text-sm leading-relaxed">
                ...
                <p>
                  너는 혹시 타로를 본 적이 있냐마?
                  타로를 볼 때마다 결과가 다르다고 느낀 적은 없냐마?
                </p>
                <p>
                  같은 주제로 찾아가도 모든 사람에게 해당될 것 같은 뻔한 이야기만 들었을 것이다마.
                  나도 그런 것들이 참 아쉬웠다마.
                </p>
                <p>
                  그래서 나의 목표는 하나다마!
                  바로 당신에게 제대로 된 타로 결과를 재미있게 해설해주는 것이다마.
                </p>
                <p>
                ...
                <p>
                  우주를 여행하고, 많은 것을 경험하는 '0번 바보카드' 타로 이야기처럼
                  당신에게도 뜻깊은 이야기를 선사하겠다마!
                </p>
